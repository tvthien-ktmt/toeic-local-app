...
interface Part4QuestionItemCardProps {
...
/**
 * Individual sub-question card for TOEIC Part 4 Short Talks.
 */
export const Part4QuestionItemCard: React.FC<Part4QuestionItemCardProps> = ({
  questionItem,
  selectedAnswer,
  isFlagged = false,
  isExamMode = false,
    ...
    <div className="p-4 rounded-xl bg-theme-surface border border-theme space-y-3 shadow-2xs">
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-start gap-2 min-w-0">
          <span className="w-6 h-6 rounded-lg bg-theme-warning/15 text-theme-warning font-bold text-xs flex items-center justify-center shrink-0 mt-0.5">
